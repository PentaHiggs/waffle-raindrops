...
[[ 1.750985  0.070515]
 ...
 [ 2.888883  0.741103]]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{c}{\PYZsh{} TODO: Implement your clustering algorithm here, and fit it to the reduced data for visualization}
        \PY{c}{\PYZsh{} The visualizer below assumes your clustering object is named \PYZsq{}clusters\PYZsq{}}
        \PY{c}{\PYZsh{} type = 0 \PYZhy{}\PYZgt{} GMM  type = 1 \PYZhy{}\PYZgt{} KMeans}
        \PY{n+nb}{type} \PY{o}{=} \PY{l+m+mi}{1}
        \PY{n}{n\PYZus{}things} \PY{o}{=} \PY{l+m+mi}{2}
        \PY{n}{clusters} \PY{o}{=} \PY{n}{GMM}\PY{p}{(}\PY{n}{n\PYZus{}components}\PY{o}{=}\PY{n}{n\PYZus{}things}\PY{p}{)} \PY{k}{if} \PY{n+nb}{type}\PY{o}{==}\PY{l+m+mi}{0} \PY{k}{else} \PY{n}{KMeans}\PY{p}{(}\PY{n}{n\PYZus{}clusters}\PY{o}{=}\PY{n}{n\PYZus{}things}\PY{p}{)}
        \PY{k}{if} \PY{n+nb}{type} \PY{o}{==} \PY{l+m+mi}{0}\PY{p}{:}
            \PY{n}{clusters} \PY{o}{=} \PY{n}{GMM}\PY{p}{(}\PY{n}{n\PYZus{}components}\PY{o}{=}\PY{n}{n\PYZus{}things}\PY{p}{)}
        \PY{k}{else}\PY{p}{:}
            \PY{n}{clusters} \PY{o}{=} \PY{n}{KMeans}\PY{p}{(}\PY{n}{n\PYZus{}clusters}\PY{o}{=}\PY{n}{n\PYZus{}things}\PY{p}{)}
        \PY{n}{clusters}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{reduced\PYZus{}data}\PY{p}{)}
        \PY{k}{print} \PY{n}{clusters}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
KMeans(copy\_x=True, init='k-means++', max\_iter=300, n\_clusters=2, n\_init=10,
    n\_jobs=1, precompute\_distances='auto', random\_state=None, tol=0.0001,
    verbose=0)
    \end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{c}{\PYZsh{} Plot the decision boundary by building a mesh grid to populate a graph.}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{c}{\PYZsh{} TODO: Find the centroids for KMeans or the cluster means for GMM }
        \PY{n}{centroids} \PY{o}{=} \PY{n}{clusters}\PY{o}{.}\PY{n}{means\PYZus{}} \PY{k}{if} \PY{n+nb}{type}\PY{o}{==}\PY{l+m+mi}{0} \PY{k}{else} \PY{n}{clusters}\PY{o}{.}\PY{n}{cluster\PYZus{}centers\PYZus{}}
        ...
        \PY{k}{for} \PY{n}{v} \PY{o+ow}{in} \PY{n}{vectors}\PY{p}{:}
            \PY{n}{norm} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sqrt}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{v}\PY{p}{,}\PY{n}{v}\PY{p}{)}\PY{p}{)}
            \PY{n}{vp} \PY{o}{=} \PY{n}{v} \PY{o}{/} \PY{n}{norm}
            \PY{k}{print} \PY{l+s}{\PYZdq{}}\PY{l+s+si}{\PYZpc{}i}\PY{l+s}{ * }\PY{l+s+si}{\PYZpc{}r}\PY{l+s}{ = }\PY{l+s+si}{\PYZpc{}r}\PY{l+s}{ }\PY{l+s}{\PYZdq{}} \PY{o}{\PYZpc{}} \PY{p}{(}\PY{n}{norm}\PY{p}{,} \PY{n}{np}\PY{o}{.}\PY{n}{around}\PY{p}{(}\PY{n}{vp}\PY{p}{,}\PY{n}{decimals}\PY{o}{=}\PY{l+m+mi}{5}\PY{p}{)}\PY{o}{.}\PY{n}{tolist}\PY{p}{(}\PY{p}{)} \PY{p}{,} \PY{n}{np}\PY{o}{.}\PY{n}{around}\PY{p}{(}\PY{n}{v}\PY{p}{,}\PY{n}{decimals}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{)}\PY{o}{.}\PY{n}{tolist}\PY{p}{(}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
2 * [-0.53134, 0.02045, 0.11389, -0.70802, -0.01808, -0.45019] = [-1.26, 0.05, 0.27, -1.69, -0.04, -1.07] 
3 * [-0.08969, -0.35581, -0.36583, -0.22292, -0.73629, -0.37377] = [-0.34, -1.35, -1.39, -0.85, -2.8, -1.42]
    \end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{c}{\PYZsh{} Put the result into a color plot}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{customer_segments_files/customer_segments_26_0.png}
    \end{center}
    { \hspace*{\fill} \\}
